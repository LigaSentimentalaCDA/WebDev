const apikey = "bdfa3cef3807202fcc92aaea4fdd5d40";
...
const spinner2 = document.querySelector(".forecstD")

function loadData() {
    spinner2.removeAttribute('hidden');
    fetch('https://www.mocky.io/v2/5185415ba171ea3a00704eed?mocky-delay=4000ms')
        .then(response => response.json())
        .then(data => {
            spinner2.setAttribute('hidden', '');
            document.querySelector(".forecstD").classList.remove(".loading2")
